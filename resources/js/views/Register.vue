<template>
    <div class="max-w-md mx-auto bg-white/5 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-2xl">
        <h2 class="text-3xl font-black mb-6 text-center uppercase tracking-tighter italic">
            Join the <span class="text-yellow-600">Cinema</span>
        </h2>
        ...
        <form @submit.prevent="handleRegister" class="space-y-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-400 mb-2 uppercase tracking-widest">Confirm Password</label>
                <input 
        ...
        <p class="mt-8 text-center text-gray-400">
            ...
            <router-link to="/login" class="text-yellow-600 hover:text-yellow-500 font-bold transition-colors">Login</router-link>
        </p>
    </div>
</template>
